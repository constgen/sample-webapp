...
$__System.registerDynamic("3", [], true, function($__require, exports, module) {
  ...
  module.exports = {
    "name": "sample-webapp",
    "private": true,
    "description": "A project sample for a web application",
    "version": "0.1.0",
    "license": "MIT",
    "author": "constgen",
    "main": "src/index.html",
    "repository": {
      "type": "git",
      "url": "https://github.com/constgen/sample-webapp.git"
    },
    "keywords": ["sample", "webapp", "project template"],
    "dependencies": {},
    "devDependencies": {
      "grunt": "1.0.1",
      "grunt-jsdoc": "1.0.0",
      ...
      "bower-traceur": "git://github.com/jmcriffey/bower-traceur"
    },
    "scripts": {
      "start": "node tasks/server.js",
      "test": "grunt test",
      "build": "grunt build",
      "live": "grunt live",
      "code": "grunt code"
...
$__System.registerDynamic("4", ["2", "3"], true, function($__require, exports, module) {
  ...
  var define,
      global = this,
      GLOBAL = this;
  var publicAPI = $__require('2'),
      packageManifest = $__require('3');
...
$__System.registerDynamic("1", ["4"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
